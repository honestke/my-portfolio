...
export function Sidebar({ unreadCount = 0 }: { unreadCount?: number }) {
  ...
  return (
    <>
      <div className="flex items-center justify-between border-b border-neutral-800 bg-neutral-950 px-4 py-3 sm:hidden">
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex h-screen w-64 shrink-0 -translate-x-full flex-col border-r border-neutral-800 bg-neutral-950 transition-transform duration-200 sm:static sm:translate-x-0 ${
          open ? "translate-x-0" : ""
        }`}
      >
